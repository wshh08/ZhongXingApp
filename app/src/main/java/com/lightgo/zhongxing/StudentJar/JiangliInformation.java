package com.lightgo.zhongxing.StudentJar;
...
import com.lightgo.zhongxing.R;
import com.lightgo.zhongxing.UserMessage.LoginActivity;
...
public class JiangliInformation extends Activity implements View.OnClickListener{
    private LinearLayout jline = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jiangli_information);
        Get();
        listdata=new ArrayList<Map<String, Object>>();
        jline = (LinearLayout) findViewById(R.id.jiangreturn);
        jline.setOnClickListener(this);
        jlist = (ListView)findViewById(R.id.jianglist);
        simpleAdapter = new SimpleAdapter(this, getData(), R.layout.jianglistinfo,
                new String[]{"jianglistudent","title", "time","grade"}, new int[]{R.id.jianglistudent,R.id.jiangliname,R.id.jianglitime,R.id.jiangligrade});
        jlist.setAdapter(simpleAdapter);

    }
    private List<Map<String, Object>> getData() {
        for (int i = 1 ; i <= b * c; i += c) {
            Map<String, Object> map = new HashMap<String, Object>();
            map.put("jianglistudent", dateAfterSplit1[i]);
    ...
    public void Get() {
        new Thread()
        {
            ...
            public void run()
            {
                String s = httpUrlConnection(pathAPI+"AndroidReword", LoginActivity.UserName);
