...
public class LoginActivity extends Activity implements View.OnClickListener,Handler.Callback{
    ...
    private String pathAPI = "http://120.77.40.249:2017/Home/";
    ...
    public boolean handleMessage(Message message) {
        switch (message.what){
            case 0:
                ...
                String mUserName = muserInfo.UserName;
                String mPassWord = muserInfo.PassWord;
                GetInfo(mUserName,mPassWord);
                break;
            case 1:
                ...
                editor.commit();
                MainActivity.UserID =  userInfo.UserName;
