...
import com.lightgo.zhongxing.StudyCommunity.Sq_util.DateUtils;
import com.lightgo.zhongxing.StudyCommunity.Sq_util.ImageUtils;
import com.lightgo.zhongxing.StudyCommunity.Sq_util.SDCardUtil;
import com.lightgo.zhongxing.StudyCommunity.Sq_util.ScreenUtils;
            ...
            case R.id.action_new_post:
                ...
                if((curClickTime - lastClickTime) >= MIN_CLICK_DELAY_TIME) {
                    ...
                    if( content.length()<15)
                        Toast.makeText(getApplicationContext(), "发布失败！字数不能少于15个", Toast.LENGTH_SHORT).show();
